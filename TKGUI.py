...
class ModeSelector:
    def __init__(self):
        ...
        self.hand_button = tk.Button(self.root, text="Hand Mode", command=self.select_hand_mode)
        self.hand_button.pack()

        self.eye_button = tk.Button(self.root, text="Eye Mode", command=self.select_eye_mode)
