...
class ModeSelector:
    def __init__(self):
        ...
        self.hand_button = CTkButton(self.root, text="Hand Mode", command=self.select_hand_mode)
        self.hand_button.pack()

        self.eye_button = CTkButton(self.root, text="Eye Mode", command=self.select_eye_mode)
